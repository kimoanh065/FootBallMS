...
public class PlayerList extends JFrame {
	...
	public PlayerList() {
		...
		lbbackground.setIcon(new ImageIcon(PlayerList.class.getResource("/background/san3.jpg")));
		...
		lbsearch.setForeground(new Color(64, 224, 208));
		...
		lbfilter.setForeground(new Color(255, 140, 0));
